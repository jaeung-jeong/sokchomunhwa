	...
	{ type:"window"		, id:"top_window"				, 'class':"mainobjects", visible:"pc", children:[
		...
		{ type:"window"		, id:"menu_window"			, 'class':"mainobjects togglewnd"		, children:[
			...
			{ type:"window"		, id:"menu_contents"			, 'class':"mainobjects"	, children:[
				...
				{ type:"image"		, id:"menu_memo_btn"			, 'class':"menuobjects", src:"menu/memo.svg"			, title:"메모"			, click:"eFnc.runMemo()&eFnc.wndHide('.togglewnd')"},
				{ type:"image"		, id:"menu_draw_btn"			, 'class':"menuobjects", src:"menu/drawing.svg"		, title:"판서"			, click:"eFnc.runDrawing()&eFnc.wndHide('.togglewnd')" },
